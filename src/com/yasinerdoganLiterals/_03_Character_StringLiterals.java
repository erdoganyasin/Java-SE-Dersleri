package com.yasinerdoganLiterals;
...
public class _03_Character_StringLiterals {
	...
	public static void main(String[] args) {
		...
		long hexWord = 0xCAFE_BABE;
		long maxLong = 0x7fff_ffff_ffff_ffffL;
		byte nybbles = 0b0010_0101;
		long bytes = 0b11010010_01101001_10010100_10010010;
		
		System.out.println("kredikartýNo   :" + krediKartiNo);
		System.out.println("sskNo          :" + sskNo);
		System.out.println("piSayisi  	   :" + piSayisi);
		System.out.println("hexBytes  	   :" + hexBytes);
		System.out.println("hexWord        :" + hexWord);
